...
public class User {
    ...
    public void serUserID(int userID){this.userID=userID;}
    ...
    public void setfansnum(int fansnum){this.fansNum=fansnum;}
    public void setlikesnum(int likesNum){this.likesNum=likesNum;}
    public void setblogsnum(int blogsNum){this.blogsNum=blogsNum;}
    ...
    public int getBlogsNum(){return blogsNum;}
