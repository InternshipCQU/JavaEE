...
public class BlogWritingServiceImpl implements BlogWritingService {
    ...
    @Override
    public void addBlog(String blogTitle, String blogContent,String createTime, String tagName, String summaryContent, HttpServletRequest request) {
        ...
        blogWritingMapper.addblog(blogTitle, blogContent, createTime, tagID, userID, summaryContent);
    ...
    @Override
    public void submitBlog(String blogTitle, String blogContent, String createTime, String tagName, String summaryContent, HttpServletRequest request){

        int userID = (Integer) request.getSession().getAttribute("userID");

        addBlog(blogTitle, blogContent, createTime, tagName, summaryContent, request);
