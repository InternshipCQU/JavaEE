/*! Editor.md v1.5.0 | editormd.min.js | Open source online markdown editor. | MIT License | By: Pandao | https://github.com/pandao/editor.md | 2015-06-09 */ ! function (e) {
    ...
    if ("undefined" != typeof e) {
        ...
        t.title = t.$name = "Editor.md", t.version = "1.5.0", t.homePage = "https://pandao.github.io/editor.md/", t.classPrefix = "editormd-", t.toolbarModes = {
            ...
            lang: {
                name: "zh-cn",
                description: "开源在线Markdown编辑�?<br/>Open source online Markdown editor.",
                tocTitle: "�?�?",
                toolbar: {
                    undo: "撤销（Ctrl+Z�?",
                    redo: "重做（Ctrl+Y�?",
                    ...
                    "code-block": "代码块（多�??言风格�?",
                    table: "添加表格",
                    datetime: "日期时间",
                    emoji: "Emoji表情",
                    "html-entities": "HTML实体字�??",
                    pagebreak: "插入分页�?",
                    "goto-line": "跳转到�??",
                    watch: "关闭实时预�??",
                    unwatch: "开�?实时预�??",
                    preview: "全窗口�?��?�HTML（按 Shift + ESC还原�?",
                ...
                dialog: {
                    ...
                    referenceLink: {
                        ...
                        urlId: "链接ID",
                        urlTitle: "链接标�??",
                        nameEmpty: "错�??：引用链接的名称不能为空�?",
                        idEmpty: "错�??：�?�填写引用链接的ID�?",
                        urlEmpty: "错�??：�?�填写引用链接的URL地址�?"
                    },
                    image: {
                        title: "添加图片",
                        url: "图片地址",
                        ...
                        alt: "图片描述",
                        uploadButton: "�?地上�?",
                        imageURLEmpty: "错�??：图片地址不能为空�?",
                        uploadFileEmpty: "错�??：上传的图片不能为空�?",
                        formatNotAllowed: "错�??：只允�?�上传图片文件，允�?�上传的图片文件格式有："
                    },
                    preformattedText: {
                        title: "添加预格式文�?或代码块",
                        emptyAlert: "错�??：�?�填写�?�格式文�?或代码的内�?��?"
                    },
                    codeBlock: {
                        title: "添加代码�?",
                        selectLabel: "代码�?言�?",
                        selectDefaultText: "请选择代码�?言",
                        otherLanguage: "其他�?言",
                        unselectedLanguageAlert: "错�??：�?�选择代码所属的�?言类型�?",
                        codeEmptyAlert: "错�??：�?�填写代码内容�?"
                    },
                    htmlEntities: {
                        title: "HTML 实体字�??"
                    },
