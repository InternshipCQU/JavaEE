...
public class user {
    ...
    public String avatar;               // 头像的base64码
    public String lastLogin;            // 上一次登录时间
    public String fansNum;              // 粉丝数，默认为0
    public String likesNum;             // 点赞数，默认为0
    public String blogsNum;             // 博客数，默认为0
    ...
    public void setUserRegisterTime(String userRegisiterTime) {
        this.userRegisterTime = userRegisiterTime;
    }
